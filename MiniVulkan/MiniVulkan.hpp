...
#define MINIVK_LIBRARY
    /*
        ...
        C/C++ | General | Additional Include Directories:
            RELEASE: ...\VulkanSDK\1.3.239.0\Include;...\glfw-3.3.7.bin.WIN64\glfw-3.3.7.bin.WIN64\include;
    ...
    */
    ...
    ///     0. Create a vector of a set of vertices for a quad-mesh (and index vector if needed).
    ///     1. Create a MvkBuffer with a MvkBufferType::VKVMA_BUFFER_TYPE_VERTEX
    ///     2. Give it a size of VertexCount * sizeof(VertexStruct)
    ///     3. Stage the vertex data (CPU vertex data is transfered to GPU).
    ///     4. If needed also create buffer with index type for indexing vertices and stage index data.
    ///     5. Load a QOI image into memory and keep track of its pointer.
    ///     6. Create an MvkImage and give it a size of the QOI image with the appropaite format.
    ///     7. Using the MvkImage stage the QOI image pointer data (transfer from CPU to GPU).
    ///     8. Use PushDescriptors to bind the image to the shader(s).
    ///     9. In the render event bind the vertex/index buffers to the render pipeline.
    ///    10. Use PushConstants to push the 2D projection matrix to the Vertex shader.
    ///    10. Call draw commands specifying the vertices/indices to be used.
    /// 
    /// RENDER CONCERNS:
    ///     1. All render calls MUST be sorted sorted by depth for depth/transparency to work properly.
    ///     2. If you do not sort render calls by depth, they're depth will be sorted by render order.
    ///     3. Depth Testing: Enabled by default, is performance method for discarding fragments when
    ///         they do not pass a depth test against the depth image generated by prior render calls.
    
#endif