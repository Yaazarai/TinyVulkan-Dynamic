#pragma once
#ifndef MVK2D_MVKLIBRARY
#define MVK2D_MVKLIBRARY
    /*
    ...
    */
    ...
    /// You can define MINIVULKAN_SHORTREF for a shorter namespace reference. (:
    #ifdef MINIVULKAN_SHORTREF
    namespace mvk = minivulkan;
    #endif

    /// Enables validation layers only for debug mode.
	#ifdef _DEBUG
    ...
    /// MvkBuffer is the base-derivable buffer class for handling memory operations with the GPU.
    ///     *** All MvkBuffer operations are STAGED (see header file for documentation info).
